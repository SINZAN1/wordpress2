...
if ( class_exists( 'WP_Customize_Control' ) && ! class_exists( 'Country_Inn_Customize_Icons_Control' )):
	class Country_Inn_Customize_Icons_Control extends WP_Customize_Control {
            ...
            <label>
                ...
                <span class="pt-customize-icons">
                    ...
                    <span class="icon-toggle">
                        <?php echo ( empty( $value )? __('Add Icon','country-inn'): __('Edit Icon','country-inn') ); ?>
                        <span class="dashicons dashicons-arrow-down"></span>
                    </span>
                    <span class="icons-list-wrapper hidden">
                        <input class="icon-search" type="text" placeholder="<?php esc_attr_e('Search Icon','country-inn')?>">
	                    <?php
	                    $fa_icon_list_array = country_inn_icons_array();
...
if ( class_exists( 'WP_Customize_Control' ) && ! class_exists( 'Country_Inn_Repeater_Control' )):
	/**
	 ...
	 *
	 */
	class Country_Inn_Repeater_Control extends WP_Customize_Control {
		/**
		 * The control type.
		 *
		 * @access public
		...
		public function enqueue(){
			...
			wp_enqueue_style( 'pt-customizer-repeater-style', get_template_directory_uri() . '/xclusivethemes/customizer-repeater/customizer-repeater.css', array(), '3.3.6' );
			wp_enqueue_script( 'pt-customizer-repeater-script', get_template_directory_uri() . '/xclusivethemes/customizer-repeater/customizer-repeater.js', array('jquery', 'jquery-ui-draggable' ), '1.0.0', true  );
		}
                    ...
                    <div class="repeater-fields hidden">
                            ...
                            <div class="single-field type-<?php echo esc_attr( $field['type'] ) . ' ' . $class; ?>">
								...
								switch ( $field['type'] ) {
									...
									case 'icons':
                                        ...
                                        <span class="icon-toggle">
                                            <?php echo __('Add Icon','country-inn'); ?>
                                            <span class="dashicons dashicons-arrow-down"></span>
                                        </span>
                                        <span class="icons-list-wrapper hidden">
                                            <input class="icon-search" type="text" placeholder="<?php esc_attr_e('Search Icon','country-inn')?>">
                        ...
                        <div class="clearfix repeater-footer">
                            <a class="repeater-field-remove" href="#remove">
								<?php _e( 'Delete', 'country-inn' ) ?>
                            </a> |
                            <a class="repeater-field-close" href="#close">
								<?php _e( 'Close', 'country-inn' ) ?>
                            </a>
                        </div>
                    </div>
                </li>
                                ...
                                <div class="single-field type-<?php echo esc_attr( $field['type'] ) . ' ' . $class; ?>">
									...
									switch ( $field['type'] ) {
										...
										case 'icons':
                                            ...
                                            <span class="icon-toggle">
                                                <?php echo ( empty( $new_value )? __('Add Icon','country-inn'): __('Edit Icon','country-inn') ); ?>
                                                <span class="dashicons dashicons-arrow-down"></span>
                                            </span>
                                            <span class="icons-list-wrapper hidden">
                                                <input class="icon-search" type="text" placeholder="<?php esc_attr_e('Search Icon','country-inn')?>">
